...
public class VentanaGemelo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaGemelo frame = new VentanaGemelo();
	...
	public VentanaGemelo() {
		...
		ArrayList<String> aRutas = VentanaElegirEjercicios.bd.obtenerRutasFotosGemelos();
