...
public class VentanaPecho extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaPecho frame = new VentanaPecho();
	...
	//Funciona todo. Falta meter los gifs
	public VentanaPecho() {
		...
		JLabel lblEjerciciosDeAbdominales = new JLabel("Ejercicios de pecho");
		...
		ArrayList<String> aRutas = VentanaElegirEjercicios.bd.obtenerRutasFotosBiceps();
